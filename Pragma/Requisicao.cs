...
namespace Pragma
{
    public class Requisicao
    {
        ...
        public string RequisicaoWeb(string pUrl)
        {
            return RequisicaoWeb(pUrl, null, null, null, null, 0);
        }

        public string RequisicaoWeb(string pUrl, string pMetodo, NetworkCredential pCredencial, string pContentType, string pBody)
        {
            return RequisicaoWeb(pUrl, pMetodo, pCredencial, pContentType, pBody, 0);
        }
        ...
        public T DeserializarObjeto<T>(string pJson)
        {
            return JsonConvert.DeserializeObject<T>(pJson);
        }

        public string SerializarObjeto<T>(T pObjeto)
        {

...
namespace Pragma.DataBase
{
    public class SqlServer
    {
        ...
        public static DB.SqlServer RetornaDB(UserDB pUsuario, string pServidor, string pBanco = "master")
        {
            if (pUsuario == null)
                return new DB.SqlServer(pServidor);
            else
                return new DB.SqlServer(pServidor, pBanco, pUsuario.Usuario, pUsuario.Senha);
        }
